...
% Reference_image(find((abs(X_prime) < 0.6 * a_prime) & (abs(Z_prime) < 0.15 * b_prime))) = 1; 
...
N_min_sampling_points = 23;
N_max_sampling_points = 23;
...
load Coeff_opt_final_23_points.mat
