...
data_temp1.im_final = data_temp1.im_final .* exp(-1j * (4 * pi / c * RHO_IN1) * fc);
...
Reconstruction_Nearest1     = interp2(RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, 'nearest', ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
Reconstruction_Linear1      = interp2(RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, 'linear',  ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
Reconstruction_Cubic1       = interp2(RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, 'cubic',   ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
Reconstruction_Spline1      = interp2(RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, 'spline',  ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
Reconstruction_KnabNFFT1    = knabNFFT2D(ExtrapVal, RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, (1 / deltarho1) * 0.5, (1 / deltacosalpha1) * 0.5) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
Reconstruction_RectNFFT1    = rectNFFT2D(ExtrapVal, RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, (1 / deltarho1) * 0.5, (1 / deltacosalpha1) * 0.5) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
Reconstruction_Knab1        = knab2D(    ExtrapVal, RHO_IN1, COSALPHA_IN1, data_temp1.im_final, RHO_OUT1, COSALPHA_OUT1, (1 / deltarho1) * 0.5, (1 / deltacosalpha1) * 0.5) .* exp(1j * (4 * pi / c * RHO_OUT1) * fc);
...
data_temp2.im_final = data_temp2.im_final .* exp(-1j * (4 * pi / c * RHO_IN2) * fc);

deltarho2       = mean(diff(RHO_IN2(1, :)));
deltacosalpha2  = mean(diff(COSALPHA_IN2(:, 1)));

% --- Interpolation of the image from the input local polar grid to the final global polar grid
Reconstruction_Nearest2     = interp2(RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, 'nearest', ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
Reconstruction_Linear2      = interp2(RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, 'linear',  ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
Reconstruction_Cubic2       = interp2(RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, 'cubic',   ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
Reconstruction_Spline2      = interp2(RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, 'spline',  ExtrapVal) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
Reconstruction_KnabNFFT2    = knabNFFT2D(ExtrapVal, RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, (1 / deltarho2) * 0.5, (1 / deltacosalpha2) * 0.5) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
Reconstruction_RectNFFT2    = rectNFFT2D(ExtrapVal, RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, (1 / deltarho2) * 0.5, (1 / deltacosalpha2) * 0.5) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
Reconstruction_Knab2        = knab2D(    ExtrapVal, RHO_IN2, COSALPHA_IN2, data_temp2.im_final, RHO_OUT2, COSALPHA_OUT2, (1 / deltarho2) * 0.5, (1 / deltacosalpha2) * 0.5) .* exp(1j * (4 * pi / c * RHO_OUT2) * fc);
