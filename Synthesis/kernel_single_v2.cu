...
extern const float aap		= (float)(M_x - 1) * (dx / 2.f);    // Reflectarray semi-dimension along the x-axis
extern const float bap		= (float)(M_y - 1) * (dy / 2.f);    // Reflectarray semi-dimension along the y-axis
